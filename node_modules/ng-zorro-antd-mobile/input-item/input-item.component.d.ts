import { AfterViewInit, EventEmitter, OnInit, OnChanges, Renderer2, ElementRef, TemplateRef } from '@angular/core';
import { ControlValueAccessor } from '@angular/forms';
export declare class InputItemComponent implements OnInit, AfterViewInit, OnChanges, ControlValueAccessor {
    private element;
    private render;
    prefixCls: string;
    wrapCls: object;
